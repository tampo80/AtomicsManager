...
namespace AtomicsManager.Migrations
{
    ...
    [Migration("20180922100920_budjet")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.BonDeCommande", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DAL.Models.BonLivraison", b =>
                {
                    ...
                    b.Property<bool>("IsInSla");

                    b.Property<string>("Livreure");

                    b.Property<bool>("MatchToBon");

                    b.Property<int>("NoteFournisseur");

                    b.Property<string>("RefBL");
            ...
            modelBuilder.Entity("DAL.Models.BonLivraison", b =>
                {
                    b.HasOne("DAL.Models.ApplicationUser", "Controleur")
                        .WithMany("BonLivraison")
                        .HasForeignKey("ControleurId");
