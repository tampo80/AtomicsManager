...
userAuthentication(userName, password) {
  ...
  let header = new HttpHeaders({ 'Content-Type': 'application/x-www-form-urlencoded', 'No-Auth': 'True'  });
  ...
  public get currentUser() : User {
    ...
    let user=<User>JSON.parse(localStorage.getItem(DbKeyService.CURRENT_USER));
