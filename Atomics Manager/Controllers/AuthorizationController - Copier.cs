...
namespace Atomics_Manager.Controllers {
    public class AuthorizationController : Controller {
        ...
        private async Task<AuthenticationTicket> CreateTicketAsync (OpenIdConnectRequest request, ApplicationUser user) {
            ...
            //if (request.HasScope("marketing-tool"))
            //{
            //    resources.Add("marketing-api");
            //}
        ...
        //public static IEnumerable<string> GetResources(this OpenIdConnectRequest request)
        //{
        //    if (request == null)
        //    {
        ...
        //    var resource = (string)request["resource"];
